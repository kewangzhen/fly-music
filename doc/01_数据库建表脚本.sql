...
CREATE TABLE hot_ranking (
    ...
    INDEX idx_song (song_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='热门榜单表(单数)';
...
-- 21. 听歌报告表
-- ==========================================
DROP TABLE IF EXISTS listening_report;
CREATE TABLE listening_report (
    id BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT '报告ID',
    user_id BIGINT NOT NULL COMMENT '用户ID',
    report_date DATE NOT NULL COMMENT '报告日期',
    total_listen_time INT DEFAULT 0 COMMENT '总听歌时长(分钟)',
    total_songs INT DEFAULT 0 COMMENT '听歌数',
    total_artists INT DEFAULT 0 COMMENT '歌手数',
    total_albums INT DEFAULT 0 COMMENT '专辑数',
    favorite_songs JSON DEFAULT NULL COMMENT '最常听的歌曲JSON',
    favorite_genres JSON DEFAULT NULL COMMENT '常听风格JSON',
    favorite_time JSON DEFAULT NULL COMMENT '常听时间段JSON',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
